...
Обычно в приложениях, написанных полностью на React, есть только один корневой элемент. При встраивании React в существующее приложение вы можете рендерить в таком количестве  независимых корневых элементов, котором посчитаете нужным.
